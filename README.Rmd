...
1. [An example of PHPM with a linear LGM](articles/Linear-Latent-Growth-Model.html)
1. [An example of PHPM with a second-order LGM](articles/Second-Order-Latent-Growth-Model.html)
1. [An example of PHPM with an autoregression and cross-lagged model]()
1. [Wave-level PM designs]()
1. [Item-level PM designs]()
1. [Forward assembly]()
<!-- 1. [Attrition] -->
1. [Summarize the optimal design]()
1. [Plot the optimal design]()
